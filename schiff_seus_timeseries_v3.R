...
path1 <- '~/Documents/GitHub/data/schiff cn age models 03-13-2019.csv'
path2 <- 'C:/Users/jschiff.GEOSAD/Google Drive/projects/rproj/seus/data/schiff cn age models 03-13-2019.csv'
